...
// 2. Напишите код, который создаст файл person.json в директории запускаемого скрипта 
// и запишет в файл следующий объект:
...
fs.writeFileSync(path.join(__dirname, 'person.json'), JSON.stringify(person, null, 4))
